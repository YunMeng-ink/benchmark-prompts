...
description: 用 bench 工具集对本地 LLM 跑 benchmark 提示词测试。当用户想“随机测一条模型”、“按 id 一键测试”、“给刚才的测试结果打分”、“同步提示词库”或“上传自己的测试题”时使用。覆盖选题、原样投喂、打分、复核的完整流程。
---
